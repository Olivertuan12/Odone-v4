    ...
    <div className="bg-[#121214] border border-white/5 rounded-2xl overflow-hidden shadow-2xl flex flex-col h-[500px]">
      ...
      <div className="p-4 bg-[#0D0D0E] border-t border-white/5 flex items-center justify-between">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button onClick={onClose} className="px-4 py-1.5 border border-white/10 hover:bg-white/5 text-white font-bold rounded-lg text-[10px] uppercase tracking-widest transition-colors flex items-center gap-2">
            Cancel
          </button>
        </div>
      </div>
